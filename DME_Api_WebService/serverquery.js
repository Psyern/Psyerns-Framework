...
// gamedig 5: named `GameDig` export with a static query() (was destructured
// `{ query }` in v4). Result shape (state.raw.*, state.connect, …) is unchanged
// for DayZ A2S responses.
